exports.seed = function(knex, Promise) {
  return Promise.join(
    ...
    knex('authors').insert({id: 7, first_name: 'William S.', last_name: 'Burroughs'}),
    knex('authors').insert({id: 8, first_name: 'Charles', last_name: 'Dickens'}),
    knex('authors').insert({id: 9, first_name: 'Elizabeth', last_name: 'Knox'}),
    knex('authors').insert({id: 10, first_name: 'John', last_name: 'Mulgan'}),
    knex('authors').insert({id: 11, first_name: 'J.K.', last_name: 'Rowling'})
  );
};
